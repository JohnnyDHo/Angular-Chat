...
export class AppComponent {
	...
	addUser() {
		const { userId } = this;
		axios
			.post('https://chat-ang.herokuapp.com/users', { userId })
			.then(() => {
				const tokenProvider = new Chatkit.TokenProvider({
					url: 'https://chat-ang.herokuapp.com/authenticate'
				});
				const chatManager = new Chatkit.ChatManager({
					instanceLocator: 'v1:us1:35cf7869-ddda-46c2-9a42-4d89f749e2d5',
					userId,
					tokenProvider
				});
				return chatManager
